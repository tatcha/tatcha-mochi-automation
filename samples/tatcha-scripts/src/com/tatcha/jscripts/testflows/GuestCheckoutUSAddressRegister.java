...
/**
 * Flow 11 : Add to cart - Checkout as guest - Add US address - Add Gift card -
...
public class GuestCheckoutUSAddressRegister {
    ...
    private final String FLOW_ID = "FLOW_11";
    ...
    public void setUp() throws Exception {
        ...
        data.load(new FileInputStream(getClass().getResource("/testFlows/GuestCheckoutUSAddressRegister.properties").getFile()));
