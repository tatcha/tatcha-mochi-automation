...
/**
 * Flow : Add to cart - Login in Checkout page - Select a US address - Add Gift
 * card - Place order
 * 
 * @author Reshma
 *
 */
public class LoginCheckoutSelectAddressUS {
    ...
    private final static Logger logger = Logger.getLogger(LoginCheckoutSelectAddressUS.class);

    private static TestMethods tmethods;
    private TestCase testCase;
    private List<TestCase> tcList = new ArrayList<TestCase>();
    private final String MODULE = "Flow-5 : LoginCheckoutSelectAddressUS";
    private final String FLOW_ID = "FLOW_5";
    ...
    public void setUp() throws Exception {
        ...
        data.load(new FileInputStream(getClass().getResource("/testFlows/LoginCheckoutSelectAddressUS.properties").getFile()));
     ...
     */
    @Test
    public void testLoginCheckoutSelectAddressUS() throws Exception {
    	final String FUN_ID = "FUN_5";
//        String FUNCTIONALITY = "Checkout as logged in user and selecting an existing address(US)";
//        testCase = new TestCase("Flow-5", "MOC-NIL", FUNCTIONALITY, "FAIL", "");
        ...
        try {
            ...
            shipping.verifyShippingAddress3(FLOW_ID, driver, prop, locator, user, map, tcList);
        ...
        logger.info("END testLoginCheckoutSelectAddressUS");
    }
