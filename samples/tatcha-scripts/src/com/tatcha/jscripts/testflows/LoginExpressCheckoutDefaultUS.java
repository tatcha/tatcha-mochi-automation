 ...
 *
 */
public class LoginExpressCheckoutDefaultUS {
    ...
    private final static Logger logger = Logger.getLogger(LoginExpressCheckoutDefaultUS.class);
    ...
    public void setUp() throws Exception {
        ...
        data.load(new FileInputStream(getClass().getResource("/testFlows/LoginExpressCheckoutDefaultUS.properties").getFile()));
