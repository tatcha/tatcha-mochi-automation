 ...
 *
 */
public class LoginCheckoutFirstAddressInternational {
    ...
    private final static Logger logger = Logger.getLogger(LoginCheckoutFirstAddressInternational.class);
    ...
    public void setUp() throws Exception {
        ...
        data.load(new FileInputStream(
                getClass().getResource("/testFlows/LoginCheckoutFirstAddressInternational.properties").getFile()));
    ...
    /**
     * Test the checkout flow of logged in user. With no address in address book
     * 
     * @throws Exception
     */
    @Test
...
//        testCase = new TestCase("Flow-6", "MOC-NIL", FUNCTIONALITY, "FAIL", "");
        ...
        logger.info("END testLoginCheckoutFirstAddressInternational");
    }
