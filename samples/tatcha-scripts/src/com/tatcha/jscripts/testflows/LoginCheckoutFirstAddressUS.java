...
/**
 * Flow 3 : Add to cart - Login in Checkout page - Add first US address - Select
...
public class LoginCheckoutFirstAddressUS {
    ...
    private final String FLOW_ID = "FLOW_3";
    ...
    public void setUp() throws Exception {
        ...
        data.load(new FileInputStream(getClass().getResource("/testFlows/LoginCheckoutFirstAddressUS.properties").getFile()));
