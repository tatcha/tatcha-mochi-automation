...
/**
 * Class that checks Adding/Selecting an address in Checkout - Shipping page
 * 
 * @author Reshma
 *
 */
...
//        testCase = new TestCase("TC-15.1", "MOC-NIL", FUNCTIONALITY, "FAIL", "");
        ...
        if (COUNTRY_US.equals(countryValue)) {
            ...
            if (!addAddrStateElement.isSelected()) {
                ...
                try {
                    wait.until(
                            ExpectedConditions.textToBe(By.xpath(locator.getProperty("addAddr.states").toString()),
