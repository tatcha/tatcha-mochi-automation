...
/**
 * Class that checks different shipping options of Checkout - Shipping page
 * 
 * @author Reshma
 *
 */
public class TestShippingOption {
    ...
    /**
     * Select a shipping option from list of available options in Checkout -
     * Shipping page
     * 
     * @param driver
     * @param prop
...
//        testCase = new TestCase("TC-16.1", "MOC-NIL", FUNCTIONALITY, "FAIL", "");
        ...
        getTestHelper().logAssertion(getClass().getSimpleName(),
                prop.getProperty("checkout.shippingOption.info").toString(),
        ...
        try {
            wait.until(ExpectedConditions.stalenessOf(
                    driver.findElements(By.name(locator.getProperty("shipping.optionList").toString())).get(0)));
        ...
        try {
            wait.until(ExpectedConditions.stalenessOf(
                    driver.findElements(By.name(locator.getProperty("shipping.optionList").toString())).get(0)));
            shippingOptionsListElement = driver
            ...
            getTestHelper().logAssertion(getClass().getSimpleName(),
                    shippingOptionsListElement.get(0).isSelected());
            ...
            getTestHelper().logAssertion(getClass().getSimpleName(), priceString, driver
